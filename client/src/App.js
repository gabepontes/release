        ...
        <div>
          ...
          <table class="table is-bordered is-fullwidth is-striped">
            ...
            <table class="table is-bordered is-fullwidth is-striped">
              ...
              <tbody>
                {matches[0].map((match) => (
                  <tr key={match.summonerId}>
                    <td>{match.queueType}</td>
                    <td>{match.tier}</td>
                    <td>{match.rank}</td>
                    <td>{match.summonerId}</td>
                    <td>{match.summonerName}</td>
                    <td>{match.leaguePoints}</td>
                    <td>{match.wins}</td>
                    <td>{match.losses}</td>
                    <td>{match.veteran ? 'Yes' : 'No'}</td>
                    <td>{match.inactive ? 'Yes' : 'No'}</td>
                    <td>{match.freshBlood ? 'Yes' : 'No'}</td>
                    <td>{match.hotStreak ? 'Yes' : 'No'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
