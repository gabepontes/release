...
import ulolpic from './rankimg/ULoL2.png';
  ...
  return (
    ...
    <div style={{  display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      ...
      <button className={styles.hpButton}>Home Page</button>
        ...
        <button onClick={handleHelp} className={styles.AboutButton}>FAQ</button>
...
function Homepagesoloandteam() {
  ...
  return (
    ...
    <div style={{  display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      <div className={styles.flashingtext2}>
        <img src={ulolpic}></img>
      </div>
      <br></br>
      ...
      <span className={styles.flashingtextsb}>Search by...</span>
      ...
      <div className={styles.buttons}>
        ...
        <a href ="http://localhost:3000/solo-page">
         ...
         <span className={styles.flashingtextor}>Or</span>
...
*/
  ...
  <div id="search-container">
    <form>
    <input type="text" id="search-bar" placeholder="Search..." onChange={(e) => setSearchQuery(e.target.value)}/>
    <button class="button is-info" id="search-button" type="submit" onClick={handleSubmit}>Search</button>
...
<div style={{  display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
<div className={styles.flashingtext1}>
        <img src={ulolpic}></img>
      </div>
      <br></br>
...
<span className = {styles.flashingtextvs}> VS</span>
  ...
  <div className={styles.team2}>
        ...
        <button type="submit" className={styles.searchteampagebutton}>Search</button>
</form> 
